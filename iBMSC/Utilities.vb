...
Namespace Editor
    Public Module Functions
        Public Const MaxWavIndex As Integer = 46655
        ...
        Public Function C36to10S(ByVal xChar As Char) As Integer
            ...
            Return 0
        End Function
        Public Function C10to36(ByVal xStart As Long, Optional ByVal xDigits As Integer = 2) As String
            If xStart < 1 Then xStart = 1
            Dim xValue As Long = xStart
            Dim xRet As String = ""

            Do
                xRet = C10to36S(CInt(xValue Mod 36)) & xRet
                xValue \= 36
            Loop While xValue > 0

            While xRet.Length < xDigits
                xRet = "0" & xRet
            End While

            If xRet.Length > xDigits Then xRet = Mid(xRet, xRet.Length - xDigits + 1)
            Return xRet
        End Function
        Public Function C36to10(ByVal xStart As String) As Integer
            ...
            For xI1 As Integer = 0 To xStart.Length - 1
                xRet = xRet * 36 + C36to10S(xStart.Chars(xI1))
            Next
